...
<transition-group name="unit-list" appear>
    ...
    <div class="row unit unit-list-item" v-for="unit in units" :key="unit.id">
        ...
        <div class="col-12 d-flex mb-5 py-4 justify-content-between">
            <a class="btn btn-lg btn-outline-info btn-rounded" :href="'/property/' + unit.rns_id + '/'" >Rates & Info &nbsp; <i class="fa fa-angle-right" aria-hidden="true"></i></a>
            ...
            <p v-else class="fira text-primary">Call for Availability</p>
        </div>
    </div>
</transition-group>
