...
<?php if(have_posts()): ?>
    <?php while(have_posts()): ?>
        ...
        <?php echo $__env->make('partials.buttons', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <main role="main" class="front">
            <div class="container">

                <div class="row">
                    <div class="col-lg-6">
                        <img src="<?php echo e($featuredImage['url']); ?>" class="my-3 img-fluid" alt="Cathey & Ralph Hobbs" >
                    </div>
                    <div class="col-lg-6">
                        <article class="front">
                            <header>
