<footer class="sticky-footer bg-light pt-4">
        ...
        <div class="row">
            <div class="col-lg-3 text-center text-lg-left">
                ...
                <p class="contact-info">
                    <a href="tel:<?php echo e(get_field('toll_free_phone', 'option')); ?>"><?php echo e(get_field('toll_free_phone', 'option')); ?></a> <em>toll free</em><br>
                    <a href="tel:<?php echo e(get_field('phone', 'option')); ?>"><?php echo e(get_field('phone', 'option')); ?></a> <em>local</em></p>
                <p class="contact-info"><?php echo nl2br(get_field('address', 'option')); ?></p>
                <p class="contact-info"><a href="mailto:<?php echo e(get_field('email', 'option')); ?>"><?php echo e(get_field('email', 'option')); ?></a></p>
            </div>
    ...
    <div class="bot-bot py-2">
        <p class="copyright text-center text-info">&copy;<?php echo e(date('Y')); ?> <?php echo e(get_bloginfo()); ?>. All&nbsp;Rights&nbsp;Reserved. 
